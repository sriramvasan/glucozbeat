...
const SnapGI = () => {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      const res = await fetch("https://herglucozbeat.com/api/model/detect/", {
        method: "POST",
        body: formData,
      });
      ...
      const processedImageUrl = `https://herglucozbeat.com/api/model/results/${data.processed_filename}`;
